...
var CoreAdminBase = /** @class */ (function (_super) {
    ...
    CoreAdminBase.prototype.renderCore = function () {
        ...
        catchAll = _a.catchAll, theme = _a.theme, _c = _a.title, title = _c === void 0 ? 'React Admin' : _c, loading = _a.loading, loginPage = _a.loginPage, logoutButton = _a.logoutButton, polyglotOptions = _a.polyglotOptions;
        ...
        return (react_1.default.createElement(TranslationProvider_1.default, { options: polyglotOptions },
